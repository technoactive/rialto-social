                    ...
                    <div className="relative aspect-[4/3] overflow-hidden">
                      {post.image ? (
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-pink-400 via-red-400 to-pink-500">
                          ...
                          <Heart className="absolute top-12 right-8 w-6 h-6 text-white/15 fill-white/15" />
                          <Heart className="absolute bottom-16 left-10 w-5 h-5 text-white/10 fill-white/10" />
                          <Heart className="absolute bottom-8 right-6 w-8 h-8 text-white/20 fill-white/20" />
                          
                          {/* Center content */}
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center text-white">
                              <Heart className="w-14 h-14 mx-auto mb-3 fill-white drop-shadow-lg group-hover:scale-110 transition-transform duration-300" />
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 flex items-center justify-center">
